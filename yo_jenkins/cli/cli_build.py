...
def logs(profile:str, job:str, build_number:int, build_url:str, latest:bool, download_dir:bool) -> None:
    """TODO Docstring
    ...
    # Request the data
    if valid_url_format:
        data = JY.Build.logs(build_url=build_url, job_url=job, build_number=build_number, latest=latest, download_dir=download_dir)
    else:
        data = JY.Build.logs(build_url=build_url, job_name=job, build_number=build_number, latest=latest, download_dir=download_dir)
