...
class Package():
    ...
    @staticmethod
    def install(package_name: str = 'yo-jenkins', upgrade: bool = True, user: bool = True, proxy: str = "") -> bool:
        """TODO Docstring
    ...
    @staticmethod
    def uninstall(package_name: str = 'yo-jenkins', auto_yes: bool = True) -> bool:
        """TODO Docstring
