...
J = jenkins.Jenkins(
    url='https://retailjenkins.cloud.capitalone.com/',
    username='ezg822',
...
job_name = 'Bogie/Small-Business-Money-Movement/mf-status-tracker/Bogie-migration-FROM-money-movement'
# job_name = 'Bogie/job/Small-Business-Money-Movement/job/mf-status-tracker/job/Bogie-migration-FROM-money-movement'
job_name = "https://retailjenkins.cloud.capitalone.com/job/Non-PAR/job/Non-Prod-Jobs/job/Accenture/"
job_name = "Bogie/Bank-OAO/tools-out-of-wallet-sessions-api/master"
